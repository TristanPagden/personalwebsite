  ...
  return (
    <>
      <div id='#about' className='text-center mx-auto mt-10 w-1/2 mt-20'>
        ...
        <p className='text-lg text-center pt-5'>I offer tutoring for most areas of programming from begginer to advanced, including artificial intelligence with Python, web development with Javascript and game development with C# and Unity. I also offer tutoring in Maths and all 3 sciences at GCSE level or below. I give engaging and thorough lessons personalised to your preferences and abilities. As well as this I will teach you to be an effective student and motivate yourself to learn and memorise efficiently using scientifically based methods. </p>
      </div>
